...
<body>
   <h1><img src="img/logo_sigre_2.jpg" alt="" class="logo"></h1>
    <form action="RechazarSolicitudDesarrollador.php" method="post" class="form-register" enctype="multipart/form-data">
        <h2 class="form__titulo">RECHAZAR SOLICITUD A DESARROLLADOR</h2>
        <div class="contenedor-inputs">
            ...
            <input type="text" name="NomCli" value="<?php echo $registro['UsuAsig'] ?>" class="input-48" readonly>
            
            
             <input type="file" name="Anexo" class="input-100" required>    
            
            <input type="submit" value="RECHAZAR A DESARROLLADOR" class="btn-enviar">
